...
def plot_evaluation_charts_separate(y_true, y_pred, metrics):
    ...
    """
    # --- Biểu đồ 1: Biểu đồ cột cho các chỉ số đánh giá ---
    plt.figure(figsize=(12, 7))
    metric_names = ['MAE', 'MSE', 'RMSE', 'QWK']
    ...
    # --- Biểu đồ 3: Density Plot (Phân bố điểm số) ---
    plt.figure(figsize=(10, 7))
    ...
    # --- Biểu đồ 4: Biểu đồ phân phối sai số (Error Distribution) ---
    # plt.figure(figsize=(10, 7))
